...
namespace Plus.HabboHotel.Roleplay.Timers
{
    public class workingTimer
    {
        ...
        public void startTimer()
        {
            ...
            timer = new Timer(timerFinished, null, 600000, Timeout.Infinite);
        }
        ...
        public void timerDone(object info)
        {
            try
            {
                ...
                if (timeLeft > 0)
                {
                    int minutesRemaining = timeLeft / 180000;
                    Session.SendWhisper("Sono passati 10 minuti dall'ultimo messaggio.");
                    timer.Change(180000, Timeout.Infinite);
                    return;
                }
        ...
        public int getTime()
        {
            int minutesRemaining = timeLeft / 18000;
