            ...
            if (CombatManager.CanAttack(Session, TargetSession))
            {
                ...
                if (TargetSession.GetRoleplay().CurHealth <= 0)
                {
                    ...
                    if (TargetSession.GetRoleplay().Brawl == true)
                    {
                       ...
                       Session.GetHabbo().GetRoomUser().LastBubble = 3;
                        ...
                        RoleplayManager.Shout(Session, "*Colpisce a " + TargetSession.GetHabbo().UserName + ", causando " + Damage + " di danno, cacciandolo fuori dalla rissa! [+5PNT]*");
                ...
                else
                {
                   ...
                   TargetSession.GetHabbo().GetRoomUser().LastBubble = 3;
                    ...
                    Session.Shout("*Colpisce a " + TargetSession.GetHabbo().UserName + ", causando " + Damage + " di danno. [-2 Energia]*");
                    if (TargetSession.GetRoleplay().Armor >= 1 && TargetSession.GetRoleplay().inColourWars == false)
                    {
                        RoleplayManager.commandShout(TargetSession, "*[" + TargetSession.GetRoleplay().Armor + "LP Rimasti!]*", 3);
                    }
                    else
                    {
