...
namespace Plus.HabboHotel.Rooms
{
    ...
    internal class GameItemHandler
    {
        ...
        /// </summary>
        private ConcurrentDictionary<uint, RoomItem> _banzaiTeleports;
        ...
        public GameItemHandler(Room room)
        {
            ...
            _banzaiTeleports = new ConcurrentDictionary<uint, RoomItem>();
        }
        ...
        internal void AddTeleport(RoomItem item, uint itemId)
        {
            ...
            {
                _banzaiTeleports.TryUpdate(itemId, item, item);
                return;
            }
        ...
        {
            RoomItem teleport;
            _banzaiTeleports.TryRemove(itemId, out teleport);
        }
