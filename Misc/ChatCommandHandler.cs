    ...
    class ChatCommandHandler
    {
        public static Boolean Parse(GameClient Session, string Input)
        {
            ...
            switch (Params[0].ToLower())
            {
                ...
                case "comandi":
                    {
                        ...
                        Commands += "==========================\nComandi Generali\n==========================\n";
                        Commands += "\n-\nUsetenti\n-\n";
                        Commands += ":infostanza - Vedi id della room corrente\n";
                        Commands += ":stats - Vedi le tue statistiche\n";
                        Commands += ":rpstats x - Vedi statistiche di un utente\n";
                        Commands += ":mappa - Apri il GPS\n";
                        Commands += ":whosonline - Vedi chi è online\n";
                        Commands += ":emptypets - Cancella gli animali nell'inventario (credo)\n";
                        Commands += ":mutebots - Muta i fastidiosi BOT\n";
                        Commands += ":dance <id> - Danza\n";
                        Commands += ":hotrooms - Vedi le stanze con più visitatori\n";
                        Commands += ":logout - Esegui il logout dal gioco.\n";
                        Commands += "\n";
                        Commands += "\n-\nLavori - Bar\n-\n";
                        Commands += ":offer x <item> - Vendi un oggetto\n";
                        Commands += ":sell rocks - \n";
                        Commands += "\n";
                        Commands += "==========================\nRoleplay\n==========================\n";
                        Commands += "\n-\nUtenti\n-\n";
                        Commands += ":taxi <roomid> - Ti permette di muoverti quasi a tuo piacimento.\n";
                        Commands += ":stoptaxi - Annulla la richiesta\n";
                        Commands += ":ghelp - Vedi tutti i comandi per le gang\n";
                        Commands += ":buyphone - Compra un telefono\n";
                        Commands += ":mangia - Mangi..\n";
                        Commands += ":marry <user> - \n";
                        Commands += ":divorce <user> - \n";
                        Commands += ":timeleft - Ti indica il tempo rimanente di qualunque cosa.\n";
                        Commands += ":bail <user> - \n";
                        Commands += ":dispose - Fai sparire l'erba alla vista dei fottuti sbirri\n";
                        Commands += ":text <user> <msg> - Messaggio ad un utente (Da capire)\n";
                        Commands += ":reply <user> <msg> - (Da capire)\n";
                        Commands += ":toggletexts - (Da capire)\n";
                        Commands += ":block <user> - Blocchi un utente\n";
                        Commands += ":unblock <user> - Sblocchi un utente\n";
                        Commands += ":blocklist - Mostra la lista degli utenti bloccati\n";
                        Commands += ":buycredit <amount> - Compra la ricarica telefonica";
                        Commands += "\n-\nMisc\n-\n";
                        Commands += ":rob x - Rubi ad un utente (da capire)\n";
                        Commands += ":stuck - (da capire)\n";
                        Commands += ":laws - (da capire)\n";
                        Commands += ":surrender - (da capire)\n";
                        Commands += ":rum - (da capire) Alternativa ad i bidoni interattivi\n";
                        Commands += ":smokeweed - Fumi erba e ti sale la botta\n";
                        Commands += ":eatcarrot - Mangi una carota e recuperi vita\n";
                        Commands += ":poof - [ATTENZIONE] Resetta tutti i dati del pg!!\n";
                        Commands += ":chelp - Vedi tutti i comandi delle corporazioni e dei lavori.\n";
                        Commands += ":corplist - Vedi tutti i lavori\n";
                        Commands += ":aiuto - Ti aiuterà a capire cosa puoi fare nella room dove sei.\n";
                        Commands += ":infolavori <jobid> - Vedi il lavoro specificato\n";
                        Commands += "\n";
                        Commands += "\n-\nActivities\n-\n";
                        Commands += ":workout - Corri sul Tapirulan [+FRZ]\n";
                        Commands += ":weightlift - Usi la panca per i pesi [+FRZ]\n";
                        Commands += ":relax - Usi la sedia da massaggio [+ENR]\n";
                        Commands += "\n";
                        Commands += "\n-\nEducation\n-\n";
                        Commands += ":startlearn - Inizia a leggere [+INT]\n";
                        Commands += ":stoplearn - Smette di leggere [+INT]\n";
                        Commands += "\n";
                        Commands += "\n-\nVehicles\n-\n";
                        Commands += ":buycar - Compri una macchina\n";
                        Commands += ":drive - Guidi la macchina\n";
                        Commands += ":stopdrive - Smetti di guidare\n";
                        Commands += ":plane - Vola sul tuo aereo\n";
                        Commands += ":buyplane - Compra un aereo\n";
                        Commands += ":buyfuel <amount> - Compra carburante per l'aereo\n";
                        Commands += "\n";
                        Commands += "\n-\nCombat\n-\n";
                        Commands += ":hit <user> - Colpisce un utente a mani nude\n";
                        Commands += ":shoot <user> - Spari a qualcuno con un arma da fuoco, o colpisci qualcuno con un arma bianca\n";
                        Commands += ":bomb <user> - Lanci una bomba all'utente\n";
                        Commands += ":equip <weapon> - Equipaggi un'arma\n";
                        Commands += ":unequip <weapon> - Posi l'arma.\n";
                        Commands += ":slap <user> - Schiaffeggi qualcuno..\n";
                        Commands += ":rape <user> - Rapisci qualcuno (da capire bene\n)";
                        Commands += ":reload - Ricarichi l'arma\n";
                        Commands += "\n";
                        Commands += "\n-\nAmmunation\n-\n";
                        Commands += ":buybullets <amount> - Compra la quantità specificata di proiettili\n";
                        Commands += ":buybombs <amount> - Compri la quantità specificata di bombe\n";
                        Commands += ":buyarmor <amount> - Compri la quantità specificata di giubotti antiproiettili\n";
                        Commands += "\n";
                        Commands += "\n-\nLove\n-\n";
                        Commands += ":slapass <user> - ";
                        Commands += ":kiss <user> - \n";
                        Commands += ":sex <user> - ";
                        Commands += ":oral <user> - \n";
                        Commands += ":lickfeat <user> - ";
                        Commands += ":anal <user> - \n";
                        Commands += ":masturbate <user> - ";
                        Commands += ":facial <user> - \n";
                        Commands += ":hug <user> - \n";
                        Commands += "\n";
                        Commands += "\n";
                ...
                case "infostanza":
                    {
                        ...
                        room += "====================\nInformazioni Stanza: \n====================\n\n";
                        room += "ID Stanza: " + RoomInfo.RoomData.Id + "\n";
                        room += "Nome Stanza: " + RoomInfo.RoomData.Name + "\n";
                        room += "Utenti Attuali: " + RoomInfo.RoomData.UsersNow + "/" + RoomInfo.RoomData.UsersMax + "\n\n";
                ...
                case "aiuto":
                    {
                        string help = "================== Comandi e Interattività stanza ===================\n\n";
                        using (IQueryAdapter dbClient = Plus.GetDatabaseManager().GetQueryReactor())
                        {
                ...
                case "statistiche":
                    {
                        ...
                        string GangName = (Session.GetRoleplay().GangId > 0 && GangManager.validGang(Session.GetRoleplay().GangId, Session.GetRoleplay().GangRank)) ? GangManager.GangData[Session.GetRoleplay().GangId].Name : "Nessuna";
                        string GangRank = (Session.GetRoleplay().GangId > 0 && GangManager.validGang(Session.GetRoleplay().GangId, Session.GetRoleplay().GangRank)) ? GangManager.GangRankData[Session.GetRoleplay().GangId, Session.GetRoleplay().GangRank].Name : "Nessuna";

                        Stats += "============================================\nStatistiche Personaggio \n============================================\n";
                        Stats += "Vita: " + Session.GetRoleplay().CurHealth + "/" + Session.GetRoleplay().MaxHealth + "\n";
                        if (Session.GetRoleplay().Armor >= 1)
                        {
                            Stats += "Giubotto antiproiettile: " + Session.GetRoleplay().Armor + "\n";
                        }
                        if (Session.GetRoleplay().Armor <= 0)
                        {
                            Stats += "Giubotto Antiproiettile: 0\n";
                        }
                        Stats += "Energia: " + Session.GetRoleplay().Energy + "/100\n";
                        Stats += "Fame: " + Session.GetRoleplay().Hunger + "/100\n";
                        Stats += "Igiene: " + Session.GetRoleplay().Hygiene + "/100\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nMisc Statistics \n============================================\n";
                        Stats += "Morti Totali: " + Session.GetRoleplay().Deaths + "\n";
                        Stats += "Uccisioni Totali: " + Session.GetRoleplay().Kills + "\n";
                        Stats += "Uccisioni a Mani Nude: " + Session.GetRoleplay().PunchKills + "\n";
                        Stats += "Melee Kills: " + Session.GetRoleplay().MeleeKills + "\n";
                        Stats += "Uccisioni con Armi: " + Session.GetRoleplay().GunKills + "\n";
                        Stats += "Uccisioni con Bombe: " + Session.GetRoleplay().BombKills + "\n";
                        Stats += "Pugni totali dati: " + Session.GetRoleplay().Punches + "\n";
                        Stats += "Tempo totali di Arresto: " + Session.GetRoleplay().Arrested + "\n";
                        Stats += "Arresti Totali: " + Session.GetRoleplay().Arrests + "\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nInformative Statistics \n============================================\n";
                        Stats += "Morte Corrente: " + isDead + "\n";
                        Stats += "Prigione Corrente: " + isJailed + "\n";
                        if (Session.GetRoleplay().Married_To != 0)
                        {
                            Stats += "Sposato/a: " + RoleplayManager.ReturnOfflineInfo((uint)Session.GetRoleplay().Married_To, "username") + "\n";
                        }
                        if (Session.GetRoleplay().Married_To == 0)
                        {
                            Stats += "Sposato/a con: Sei single!\n";
                        }
                        Stats += "============================================\n";

                        Stats += "\n============================================\nTimers Statistics \n============================================\n";
                        Stats += "Sessione Tapirulan: " + Session.GetRoleplay().WorkoutTimer_Done + "/" + Session.GetRoleplay().WorkoutTimer_ToDo + "\n";
                        Stats += "Sessione Panca pesi: " + Session.GetRoleplay().WeightLiftTimer_Done + "/" + Session.GetRoleplay().WeightLiftTimer_ToDo + "\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nOther Statistics \n============================================\n";
                        Stats += "ID Lavoro: " + Session.GetRoleplay().JobId + "\n";
                        Stats += "Posizione Lavoro: " + Session.GetRoleplay().JobRank + "\n";
                        Stats += "Shifts completed: " + Session.GetRoleplay().Shifts + "\n";
                        Stats += "Gang: " + GangName + "\n";
                        Stats += "Posizione Gang: " + GangRank + "\n";
                        Stats += "Gang Turf Bonus: Currently Disabled!\n";
                        Stats += "Ultima uccisione: " + Session.GetRoleplay().LastKilled + "\n";
                        ...
                        Stats += "Costituzione: " + Session.GetRoleplay().Constitution + "\n";
                        Stats += "Intelligenza: " + Session.GetRoleplay().Intelligence + "\n";
                        Stats += "Forza: " + Session.GetRoleplay().Strength + WeedBonus + "\n";
                        Stats += "Soldi nel Portafoglio: " + Session.GetHabbo().Credits + "\n";
                        Stats += "Soldi in banca: " + Session.GetRoleplay().Bank + "\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nItems carrying \n============================================\n";
                        Stats += "Marijuana: " + Session.GetRoleplay().Weed + " grams\n";
                        ...
                        Stats += "\n";
                        Stats += "Proiettili: " + Session.GetRoleplay().Bullets + "\n";
                        Stats += "Bombe: " + Session.GetRoleplay().Bombs + "\n";
                        Stats += "Armatura: " + Session.GetRoleplay().Vests + "\n";
                        Stats += "Carburante Aereo: " + Session.GetRoleplay().Fuel + "\n";
                        if (Session.GetRoleplay().Plane == 0) { Stats += "Aereo: Nessuno\n"; }
                        if (Session.GetRoleplay().Plane == 1) { Stats += "Aereo: Disponibile"; }
                        if (Session.GetRoleplay().Car == 0) { Stats += "Macchina: Nessuna\n"; }
                        if (Session.GetRoleplay().Car == 21) { Stats += "Macchina: Skyblue\n"; }
                        if (Session.GetRoleplay().Car == 22) { Stats += "Macchina: Fireball\n"; }
                        if (Session.GetRoleplay().Car == 48) { Stats += "Macchina: Doggi\n"; }
                        if (Session.GetRoleplay().Car == 54) { Stats += "Macchina: Bunni\n"; }
                        if (Session.GetRoleplay().Car == 69) { Stats += "Macchina: Beetle\n"; }
                        Stats += "============================================\n";
                ...
                case "statisticheutente":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Comando non valido syntax: :rpstats x");
                            return true;
                        }
                        else
                        {
                        ...
                        string Stats = "";
                        string isDead = (TargetSession.GetRoleplay().Dead) ? "Sì" : "No";
                        string isJailed = (TargetSession.GetRoleplay().Jailed) ? "Sì" : "No";
                        string GangName = (TargetSession.GetRoleplay().GangId > 0 && GangManager.validGang(TargetSession.GetRoleplay().GangId, TargetSession.GetRoleplay().GangRank)) ? GangManager.GangData[TargetSession.GetRoleplay().GangId].Name : "Nessuna";
                        string GangRank = (TargetSession.GetRoleplay().GangId > 0 && GangManager.validGang(TargetSession.GetRoleplay().GangId, TargetSession.GetRoleplay().GangRank)) ? GangManager.GangRankData[TargetSession.GetRoleplay().GangId, TargetSession.GetRoleplay().GangRank].Name : "Nessuna";

                        Stats += "Statistiche di: " + TargetSession.GetHabbo().UserName + "\n";
                        Stats += "============================================\nStatistiche Generali \n============================================\n";
                        Stats += "Vita: " + TargetSession.GetRoleplay().CurHealth + "/" + TargetSession.GetRoleplay().MaxHealth + "\n";
                        if (TargetSession.GetRoleplay().Armor >= 1)
                        {
                            Stats += "Giubotto Anti Proiettili: " + TargetSession.GetRoleplay().Armor + "\n";
                        }
                        ...
                        Stats += "Fame: " + TargetSession.GetRoleplay().Hunger + "/100\n";
                        Stats += "Igiene: " + TargetSession.GetRoleplay().Hygiene + "/100\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nAltre statistiche \n============================================\n";
                        Stats += "Morte totali: " + TargetSession.GetRoleplay().Deaths + "\n";
                        Stats += "Uccisioni totali: " + TargetSession.GetRoleplay().Kills + "\n";
                        Stats += "Uccisioni a mani nude: " + TargetSession.GetRoleplay().PunchKills + "\n";
                        Stats += "Uccisioni con armi: " + TargetSession.GetRoleplay().GunKills + "\n";
                        Stats += "Uccisioni con bombe: " + TargetSession.GetRoleplay().BombKills + "\n";
                        Stats += "Pugni totali: " + TargetSession.GetRoleplay().Punches + "\n";
                        Stats += "Tempo totale arrestato: " + TargetSession.GetRoleplay().Arrested + "\n";
                        Stats += "Totale volte arrestato: " + TargetSession.GetRoleplay().Arrests + "\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nInformative Statistics \n============================================\n";
                        Stats += "Morte Corrente: " + isDead + "\n";
                        Stats += "Galera Corrente: " + isJailed + "\n";
                        if (TargetSession.GetRoleplay().Married_To != 0)
                        {
                            Stats += "Sposato con: " + RoleplayManager.ReturnOfflineInfo((uint)TargetSession.GetRoleplay().Married_To, "username") + "\n";
                        }
                        if (TargetSession.GetRoleplay().Married_To == 0)
                        {
                            Stats += "Sei single!\n";
                        ...
                        Stats += "\n============================================\nTimers Statistics \n============================================\n";
                        Stats += "Sessione Tapirulan: " + TargetSession.GetRoleplay().WorkoutTimer_Done + "/" + TargetSession.GetRoleplay().WorkoutTimer_ToDo + "\n";
                        Stats += "Sessione Panca dei pesi: " + TargetSession.GetRoleplay().WeightLiftTimer_Done + "/" + TargetSession.GetRoleplay().WeightLiftTimer_ToDo + "\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nOther Statistics \n============================================\n";
                        Stats += "ID Lavoro: " + TargetSession.GetRoleplay().JobId + "\n";
                        Stats += "Posizione Lavoro: " + TargetSession.GetRoleplay().JobRank + "\n";
                        Stats += "Gang: " + GangName + "\n";
                        Stats += "Posizione Gang: " + GangRank + "\n";
                        Stats += "Gang Turf Bonus: Currently Disabled!\n";
                        Stats += "Ultima uccisione: " + TargetSession.GetRoleplay().LastKilled + "\n";
                        ...
                        Stats += "Costituzione: " + TargetSession.GetRoleplay().Constitution + "\n";
                        Stats += "Intelligenza: " + TargetSession.GetRoleplay().Intelligence + "\n";
                        Stats += "Forza: " + TargetSession.GetRoleplay().Strength + WeedBonus + "\n";
                        Stats += "Soldi nel portafoglio: " + TargetSession.GetHabbo().Credits + "\n";
                        Stats += "Soldi in banca: " + TargetSession.GetRoleplay().Bank + "\n";
                        Stats += "============================================\n";

                        Stats += "\n============================================\nOggetti \n============================================\n";
                        Stats += "Marijuana: " + TargetSession.GetRoleplay().Weed + " grammi\n";
                        Stats += "Armi: ";
                        ...
                        Stats += "\n";
                        Stats += "Proiettili: " + TargetSession.GetRoleplay().Bullets + "\n";
                        Stats += "Bombe: " + TargetSession.GetRoleplay().Bombs + "\n";
                        Stats += "Armature: " + TargetSession.GetRoleplay().Vests + "\n";
                        if (TargetSession.GetRoleplay().Plane == 0) { Stats += "Aereo: Nessuno\n"; }
                        if (TargetSession.GetRoleplay().Plane == 1) { Stats += "Aereo: Disponibile\n"; }
                        if (TargetSession.GetRoleplay().Car == 0) { Stats += "Car: Nessuna\n"; }
                ...
                case "policecall":
                    {
                        ...
                        if (Session.GetRoleplay().Dead)
                        {
                            Session.SendWhisper("Non puoi farlo perché sei morto!");
                            return true;
                        }
                ...
                case "taxi":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Comando non valido scrivi: :taxi <roomid>", false, 34);
                            return true;
                        }
                        if (!Plus.IsNum(Params[1]))
                        {
                            Session.SendWhisperBubble("Solo numeri!", 34);
                            return true;
                        }
                        if (Convert.ToUInt32(Params[1]) == Session.GetHabbo().CurrentRoomId)
                        {
                            Session.SendWhisperBubble("Sei già nella stanza...", 34);
                            return true;
                        }
                        RoomUser User = Session.GetHabbo().GetRoomUser();
                        if (Session.GetRoleplay().inZombieInfection)
                        {
                            Session.SendWhisper("Non puoi usare ora il Taxi.", false, 34);
                            return true;
                        }
                        if (User.Frozen)
                        {
                        ...
                        {
                            Session.SendWhisper("Non hai 10 euro per chiamare il taxy.");
                            return true;
                        }
                        #endregion
                        ...
                        string TaxiMsg = "Hai richiesto un Taxi per null";
                        string TaxiMsg2 = "*Chiama un Taxi in direzione di/della null*";
                        Room Room = null;
                        RoleplayManager.GiveMoney(Session, -10);
                        Session.SendWhisper("Ti sono stati scalati 10 euro.");

                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Sintassi comando errata: :taxi <roomid>");
                            return true;
                        }
                        ...
                        if (RoomId <= 0)
                        {
                            Session.SendWhisper("RoomId errato: " + RoomId, false, 34);
                            return true;
                        }
                        if (Room == null)
                        {
                            Session.SendWhisper("C'è un problema con il luogo che vuoi raggiungere, mi dispiace!", false, 34);
                            return true;
                        }
                        ...
                        {
                            Session.SendWhisper("Non puoi chiamare un Taxi per questa destinazione, pare che dovrai camminare..", false, 34);
                            return true;
                        }

                        if (Session.GetHabbo().CurrentRoom.RoomData.Description.Contains("NOTAXIFROM"))
                        {
                            Session.SendWhisper("Mi dispiace, ma non puoi richiedere un Taxi da qui.", false, 34);
                            return true;
                        }
                        ...
                        if (!RoleplayManager.BypassRights(Session) || Session.GetHabbo().Rank == 12)
                        {
                            if (Session.GetRoleplay().Working && Session.GetRoleplay().JobHasRights("police"))
                            {
                                ...
                                TaxiMsg2 = "*Sale sulla propria volante e guida in direzione di/della " + RoomName + " [" + RoomId + "]*";
                                Session.GetRoleplay().RequestedTaxi_WaitTime = 0;
                            }
                            else if (Session.GetRoleplay().Working && Session.GetRoleplay().JobHasRights("swat"))
                            {
                                Session.GetHabbo().GetRoomUser().ApplyEffect(19);
                                TaxiMsg2 = "*Sale sul veicolo S.W.A.T e guida in direzione di/della " + RoomName + " [" + RoomId + "]*";
                                Session.GetRoleplay().RequestedTaxi_WaitTime = 0;
                            }
                            else if (Session.GetRoleplay().Working && Session.GetRoleplay().JobHasRights("gov"))
                            {
                                TaxiMsg2 = "*Sale sulla limousine nera del governo in direzione di/della " + RoomName + " [" + RoomId + "]*";
                                Session.GetRoleplay().RequestedTaxi_WaitTime = 0;
                            }

                            else if (Session.GetHabbo().HasFuse("fuse_events") && Session.GetHabbo().Rank != 12)
                            {
                                TaxiMsg2 = "*Sale sulla Limousine privata in direzione di/della " + RoomName + " [" + RoomId + "]*";
                                Session.GetRoleplay().RequestedTaxi_WaitTime = 0;
                            }
                            else if (Session.GetHabbo().HasFuse("fuse_vip") || Session.GetHabbo().Rank == 12)
                            {
                                int wantedTime = (Session.GetRoleplay().Wanted > 0) ? 3 : 0;
                                TaxiMsg2 = "*Sale sulla propria macchina privata VIP e guida in direzione di/della " + RoomName + " [" + RoomId + "]*";
                                Session.GetRoleplay().RequestedTaxi_WaitTime = wantedTime;
                            }
                            else
                            {
                                TaxiMsg = "Hai richiesto un Taxi per " + RoomName + " [" + RoomId + "]";
                                TaxiMsg2 = "*Chiama un Taxi in direzione di/della " + RoomName + " [" + RoomId + "]*";
                                Session.GetRoleplay().RequestedTaxi_WaitTime = 5;
                            }
                        }
                        else
                        {
                            TaxiMsg2 = "*Chiama un super Taxi per " + RoomName + " [" + RoomId + "]*";
                            Session.GetRoleplay().RequestedTaxi_WaitTime = 0;
                        }
                ...
                case "canceltaxi":
                    {
                        if (Session.GetRoleplay().Dead)
                        {
                            Session.SendWhisperBubble("Non puoi usare questo comando mentre sei morto!");
                            return true;
                        }
                        if (Session.GetRoleplay().Jailed)
                        {
                            Session.SendWhisperBubble("Non puoi usare questo comando mentre sei in prigione!");
                            return true;
                        }
                        if (!Session.GetRoleplay().RequestedTaxi)
                        {
                            Session.SendWhisper("Non hai richiesto un Taxi!");
                            return true;
                        }
                        else
                        {
                            ...
                            Session.Shout("*Chiama per cancellare la richiesta del Taxi*");
                ...
                case "mappa":
                    {
                        ...
                        Session.SendNotifWithScroll(Rooms);
                        RoleplayManager.Shout(Session, "*Apre lo stradario un po' confuso*", 1);
                ...
                case "give":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 2))
                        {
                            Session.SendWhisper("Comando non valido: :give <username> <amount>");
                            return true;
                        }
                        ...
                        if (Amount <= 0)
                        {
                            Session.SendWhisper("Ammontare non valido..");
                            return true;
                        }
                        if (Session.GetHabbo().Credits < Amount)
                        {
                            Session.SendWhisper("Non hai " + Amount + " euro!");
                            return true;
                        }
                        if (TargetSession == Session)
                        {
                            Session.SendWhisper("Non puoi donarti soldi da solo..");
                            return true;
                        }
                        if (Session.GetRoleplay().JobId <= 1)
                        {
                            Session.SendWhisper("Devi avere un lavoro per donare soldi.");
                            return true;
                        }
                        if (TargetSession.GetRoleplay().IsNoob)
                        {
                            Session.SendWhisper("Non puoi donare ad un nuovo utente");
                            return true;
                        }
                ...
                case "offer":
                    {
                        ...
                        if (WeaponManager.isWeapon(Offer.ToLower()))
                        {
                            ...
                            {
                                Session.SendWhisper("Non è questo il tuo lavoro!", false, 34);
                                return true;
                            }
                            ...
                            {
                                Session.SendWhisperBubble("Questo utente non può permettersela!", 1);
                                return true;
                            }

                            Session.Shout("*Offre a " + TargetSession.GetHabbo().UserName + " 1 " + Offer.ToLower() + " al prezzo di: " + WeaponManager.WeaponsData[Offer.ToLower()].Price + " euro*", 4, true);


                            TargetSession.SendWhisper("Ti hanno offerto: " + Offer.ToLower() + " al prezzo di: " + WeaponManager.WeaponsData[Offer.ToLower()].Price + ". Scrivi #accetta o #rifiuta.", false, 1, true);
                                ...
                                case "bbj":
                                    {
                                        ...
                                        {
                                            Session.SendWhisperBubble("Non è questo il tuo lavoro!", 1);
                                            return true;
                                        }
                                ...
                                case "icm":
                                    {
                                        ...
                                        {
                                            Session.SendWhisper("Non è questo il tuo lavoro!");
                                            return true;
                                        }
                                ...
                                case "phone":
                                    {
                                        ...
                                        {
                                            Session.SendWhisper("You got me feeling a type of way, boy.");
                                            return true;
                                        }
                                        ...
                                        {
                                            Session.SendWhisper("Aye, this user doesn't need 20 fucking phones, man.");
                                            return true;
                                        }
                                        RoleplayManager.Shout(Session, "*Offers " + TargetSession.GetHabbo().UserName + " an iAnx phone for $50*", 4);
                                        TargetSession.SendWhisperBubble(Session.GetHabbo().UserName + " has offered you an iChris Cellular  for $50*. Type #accept to accept or #deny to deny!", 1);
                ...
                case "buyweapon":
                    {
                        Session.SendWhisperBubble("Questo comando è inutile... Devi aspettare l'addetto.", 34);
                        return true;
                    }
                #endregion
                ...
                case "refreshweps":
                    {
                        ...
                        TargetSession.SendWhisperBubble("Un amministratore ti ha ricaricato l'arma", 1);
                ...
                case "buyphone":
                    {
                        Session.SendWhisperBubble("Coman!", 34);
                        return true;
                    }
                #endregion
                ...
                case "mangia":
                    {
                        ...
                        Session.Shout("*Si passa una mano sullo stomaco, decisamente affamato.*");
                ...
                case "timeleft":
                    {
                        if (Session.GetRoleplay().Dead)
                        {
                            Session.SendWhisper("Tranquillo tra " + Session.GetRoleplay().DeadTimer + " minuto verrai dimesso dall'ospedale");
                            return true;
                        }
                        if (Session.GetRoleplay().Jailed)
                        {
                            Session.SendWhisper("Tranquillo tra " + Session.GetRoleplay().JailTimer + " minuto/i sarai rilasciato dal carcere.");
                            return true;
                        }
                ...
                case "buyducket":
                    {
                        ...
                        #region Execute
                        RoleplayManager.Shout(Session, "*Purchases a " + Amnt + " iAnx Network Texts for $" + Pay + " [-$" + Pay + "]*");
                ...
                case "workout":
                    {
                        ...
                        {
                            Session.SendWhisper("Non sei in palestra!");
                            return true;
                        }
                        if (Session.GetRoleplay().Strength >= 20)
                        {
                            Session.SendWhisper("Hai raggiunto il limite di Forza!");
                            return true;
                        }
                        if (Session.GetRoleplay().Working)
                        {
                            Session.SendWhisper("Non puoi farlo mentre lavori.");
                            return true;
                        }
                        ...
                        if (Session.GetRoleplay().WorkingOut)
                        {
                            Session.SendWhisper("Ti stai già allenando!");
                            return true;
                        }
                        #endregion
                        ...
                        if (Inter == null)
                        {
                            Session.SendWhisper("Non sei sul tapis roulant!");
                            return true;
                        }

                        User.SetRot(Inter.Rot);
                        RoleplayManager.Shout(Session, "*Sistema come meglio preferisce la macchina, iniziando a correre.*", 1);
                        Session.GetRoleplay().WorkoutSeconds = 40;
                        Session.GetRoleplay().CalculateWorkoutTimer();
                        Session.GetRoleplay().WorkingOut = true;
                        Session.SendWhisper("Sessione: " + Session.GetRoleplay().WorkoutTimer_Done + "/" + Session.GetRoleplay().WorkoutTimer_ToDo);
                        User.IsWalking = true;
                ...
                case "weightlift":
                    {
                        ...
                        {
                            Session.SendWhisper("Hai raggiunto il limite della costituzione!");
                            return true;
                        }
                        if (Session.GetRoleplay().Working)
                        {
                        ...
                        if (Session.GetRoleplay().WeightLifting)
                        {
                            Session.SendWhisper("Stai già facendo le flessioni... POLLO!");
                            return true;
                        }
                        #endregion
                        ...
                        if (Inter == null)
                        {
                            Session.SendWhisper("Non ti trovi sulla panca!");
                            return true;
                        }
                        RoleplayManager.Shout(Session, "*Inizia ad usare la panca e pian piano sudare*", 1);
                        ...
                        Session.SendWhisper("Sessione: " + Session.GetRoleplay().WeightLiftTimer_Done + "/" + Session.GetRoleplay().WeightLiftTimer_ToDo);
                ...
                case "relax":
                    {
                        ...
                        if (Session.GetRoleplay().Jailed)
                        {
                            Session.SendWhisper("Non puoi farlo perché sei in prigione!");
                            return true;
                        }
                ...
                case "learn":
                    {
                        ...
                        if (Session.GetRoleplay().Dead)
                        {
                            Session.SendWhisper("You cannot do this whil dead!");
                            return true;
                        }
                        if (Session.GetRoleplay().Learning)
                        {
                            Session.SendWhisper("You are already learning!");
                            return true;
                        }
                        if (Session.GetRoleplay().Working)
                        {
                        ...
                        RoleplayManager.Shout(Session, "*Starts learning*");
                ...
                case "slearn":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Finisce di leggere*");
                        Session.GetRoleplay().MultiCoolDown["learning"] = 5;
                        Session.GetRoleplay().CheckingMultiCooldown = true;
                ...
                case "corplist":
                    {
                        ...
                        string corps = "-----------------------------------------\n";
                        corps += "List of All AnxRP Corporations: \n";
                ...
                case "jailbreak":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Pulls out their wirecutters and begins to cut the wires on the prison fence [5 minutes left]*");
                        Radio.send("Uhh, we have reports of a criminal attempting to free the prisoners at " + Session.GetHabbo().CurrentRoom.RoomData.Name + " [ID: " + Session.GetHabbo().CurrentRoomId + "]! All units respond!", Session, true);
                        return true;
                    }
                #endregion
                ...
                case "toggleradio":
                    {
                        ...
                        if (RadioOff)
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Turns ON their department radio*", 30);
                        }
                        else
                        {
                            Session.GetRoleplay().RadioOff = true;
                            RoleplayManager.Shout(Session, "*Turns OFF their department radio*", 30);
                        }
                        #endregion
                ...
                case "serve":
                    {
                        ...
                        if (!Session.GetRoleplay().Working)
                        {
                            Session.SendWhisper("Devi lavorare per poterlo fare!");
                            return true;
                        }
                        if (FoodItem == null)
                        {
                        ...
                        Session.Shout("*Poggia al tavolo delicatamente " + FoodItem.DisplayName + "*[+2 euro]");
                ...
                case "offerdrink":
                    {
                        ...
                        if (!RoleplayManager.CanInteract(Session, TargetSession, true))
                        {
                            Session.SendWhisper("L'utente non è nella stanza!");
                            return true;
                        }
                        #endregion
                ...
                case "spray":
                    {
                        ...
                        if (!JobManager.validJob(Session.GetRoleplay().JobId, Session.GetRoleplay().JobRank))
                        {
                            Session.SendWhisperBubble("Non è questo il tuo lavoro!", 0);
                            return true;
                        }
                        ...
                        if (isclose)
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Takes out my spray and sprays it at " + TargetSession.GetHabbo().UserName + " causing them to stop*");
                            Targ.ApplyEffect(53);
                            Targ.Frozen = true;
                ...
                case "locate":
                    {
                        ...
                        if (TargetSession == null)
                        {
                            Session.SendWhisper("L'utente non è online!");
                            return true;
                        }
                        int MyJobId = Session.GetRoleplay().JobId;
                        int MyJobRank = Session.GetRoleplay().JobRank;
                ...
                case "wanted":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 2))
                        {
                            Session.SendWhisper("Invalid command syntax: :addwanted <user> <time>");
                            return true;
                        }
                        else
                        {
                        ...
                        if (RoleplayManager.WantedListData.ContainsKey(Target.GetHabbo().UserName.ToLower()))
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Changes " + Target.GetHabbo().UserName + "'s wanted time to " + Time + " minutes*");
                        ...
                        else
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Adds " + Target.GetHabbo().UserName + " to the wanted list for " + Time + " minutes*");
                        }
                        #endregion
                ...
                case "cw":
                    {
                        ...
                        try
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Clears the wanted list*");
                        }
                        catch (Exception) { }
                        #endregion
                ...
                case "wl":
                    {
                        ...
                        foreach (KeyValuePair<string, string> User in RoleplayManager.WantedListData)
                        {
                            ...
                            Wantedlist += "Username: " + Name + "\n";
                            Wantedlist += "Wanted for: " + Time + "minutes\n";
                            Wantedlist += "Reportedly Last Seen in: " + RoomName + " [" + LastSeen + "]\n\n";
                        }
                ...
                case "stun":
                    {
                        ...
                        if (RoleplayManager.Distance(Pos1, Pos2) >= 5)
                        {
                            RoleplayManager.Shout(Session, "*Attempts to stun " + TargetSession.GetHabbo().UserName + " but misses*");
                            return true;
                        }
                        ...
                        if (isclose)
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Fires their stun-gun at " + TargetSession.GetHabbo().UserName + "*");
                            Targ.ApplyEffect(53);
                            Targ.CanWalk = false;
                            Targ.Frozen = true;
                            Targ.ClearMovement();
                ...
                case "cuff":
                    {
                        ...
                        if (isclose)
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Places their hand-cuffs on " + TargetSession.GetHabbo().UserName + " wrists*");
                ...
                case "balance":
                    {
                        ...
                        #region Execute
                        RoleplayManager.Shout(Session, "*Controlla il suo conto in banca.* Saldo: " + Session.GetRoleplay().Bank + 4 + " euro");
                ...
                case "withdraw":
                    {
                        ...
                        {
                            Session.SendWhisper("You do not have $" + Amount + " in your bank account!");
                            return true;
                        }
                        ...
                        if (wFromBank)
                        {
                            RoleplayManager.Shout(Session, "*Withdraws $" + Amount + " from their Bank Account*");
                            RoleplayManager.GiveMoney(Session, +Amount);
                        ...
                        {
                            Session.SendWhisperBubble("You must be in the Capital Bank [RoomID: 13] to withdraw your cash.", 1);
                            return true;
                ...
                case "deposit":
                    {
                        ...
                        if (Amount <= 0)
                        {
                            Session.SendWhisperBubble("Ammontare non valido!", 1);
                            return true;
                        }
                        if (Session.GetHabbo().Credits < Amount || Session.GetHabbo().Credits - Amount < 0)
                        {
                            Session.SendWhisperBubble("Non hai " + Amount + " euro da depositare!", 1);
                            return true;
                        }
                        if (!Session.GetHabbo().CurrentRoom.RoomData.Description.Contains("BANK"))
                        {
                            ...
                            {
                                Session.SendWhisperBubble("Devi avere un telefono per poterlo fare da qui! Compralo o recati in banca.", 1);
                                return true;
                            }
                        }
                        else if (Session.GetHabbo().CurrentRoom.RoomData.Description.Contains("BANK"))
                        ...
                        if (dFromBank)
                        {
                            RoleplayManager.Shout(Session, "*Deposita " + Amount + " euro nel proprio conto bancario.*");
                            RoleplayManager.GiveMoney(Session, -Amount);
                            Session.GetRoleplay().SaveQuickStat("bank", "" + (Session.GetRoleplay().Bank + Amount));
                            Session.GetRoleplay().Bank += Amount;
                        ...
                        {
                            Session.SendWhisperBubble("Devi essere in banca per poterlo fare.", 1);
                            return true;
                            /*Misc.Shout(Session, "*Deposita " + Amount + " euro nel proprio conto bancario.*");
                ...
                case "setatm":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisperBubble("Comando non valido digita: :setatm <ammontare>", 1);
                            return true;
                        }
                        else
                        {
                        ...
                        {
                            Session.SendWhisperBubble("Non hai " + Amnt + " euro in banca!", 1);
                            return true;
                        }
                        Session.GetRoleplay().AtmSetAmount = Amnt;
                        Session.SendWhisperBubble("Hai scelto quanto ritirare: " + Amnt + " euro. Ora puoi recarti al Bancomat!", 1);
                ...
                case "heal":
                    {
                        ...
                        if (!Session.GetRoleplay().Working)
                        {
                            Session.SendWhisperBubble("Devi lavorare per poterlo fare!", 1);
                            return true;
                        }
                        if (Session.GetRoleplay().Dead)
                        {
                            Session.SendWhisperBubble("Non puoi farlo perché sei morto!", 1);
                            return true;
                        }
                        if (Session.GetRoleplay().Jailed)
                        {
                            Session.SendWhisperBubble("Non puoi farlo perché sei in prigione!", 1);
                            return true;
                        }
                        ...
                        if (isclose)
                        {
                            ...
                            RoleplayManager.GiveMoney(Session, +2);
                            RoleplayManager.Shout(Session, "*Applies some bandages to " + TargetSession.GetHabbo().UserName + "'s wounds [+$2]*");
                ...
                case "discharge":
                    {
                        ...
                        if (TargetSession == null)
                        {
                            Session.SendWhisperBubble("L'utente che cerchi non è in stanza!", 1);
                            return true;
                        }
                        if (TargetSession.GetHabbo() == null)
                        {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisperBubble("Comando non valido scrivi: :discharge <username>", 1);
                            return true;
                        }
                        #endregion
                        ...
                        {
                            Session.SendWhisperBubble("Ti devi avvicinare per farlo!", 1);
                            return true;
                        }
                        #endregion
                        ...
                        if (isclose)
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Dimette finalmente " + TargetSession.GetHabbo().UserName + " dall'ospedale.* [+" + Session.GetRoleplay().JobRank + " euro]");
                ...
                case "flashbang":
                    {
                        ...
                        {
                            Session.SendWhisperBubble("To avoid abuse, you cannot use flashbang too quickly! [" + Session.GetRoleplay().MultiCoolDown["flashbang"] + "/600]", 1);
                            return true;
                        }
                ...
                case "massage":
                    {
                        ...
                        {
                            Session.SendWhisperBubble("Questo non è il tuo lavoro!", 1);
                            return true;
                        }
                        if (!Session.GetRoleplay().Working)
                        {
                        ...
                        if (Session.GetRoleplay().Dead)
                        {
                            Session.SendWhisperBubble("Non puoi farlo, sei morto...", 1);
                            return true;
                        }
                        if (Session.GetRoleplay().Jailed)
                        {
                            Session.SendWhisperBubble("Non puoi farlo, sei in prigione...", 1);
                            return true;
                        }
                        if (TargetSession.GetRoleplay().Energy == 100)
                        {
                            Session.SendWhisperBubble("Questo utente ha già l'energia al massimo!", 1);
                            return true;
                        }
                        if (!Session.GetRoleplay().MultiCoolDown.ContainsKey("massage_cooldown"))
                        {
                        ...
                        {
                            Session.SendWhisperBubble("Ti devi avvicinare per poterlo fare!", 1);
                            return false;
                        }
                        #endregion
                ...
                case "startwork":
                    {
                        ...
                        Session.GetHabbo().Motto = "[Lavorando] " + JobName + " " + RankName;
                        Session.GetRoleplay().RefreshVals();
                        Session.GetRoleplay().Working = true;
                        Session.GetRoleplay().workingTimer = new workingTimer(Session);
                        Session.GetRoleplay().SaveJobComponents();
                        RoleplayManager.Shout(Session, "*Si cambia d'abito, pronto per il suo turno di lavoro.");
                        Session.SendWhisperBubble("Tra 30 minuti, riceverai la tua prossima paga.", 1);
                ...
                case "stopwork":
                    {
                        ...
                        if (!Session.GetRoleplay().Working)
                        {
                            Session.SendWhisperBubble("Veramente non hai proprio iniziato..", 1);
                            return true;
                        }
                ...
                case "quitjob":
                    {
                        ...
                        if (Session.GetRoleplay().JobId <= 1)
                        {
                            Session.SendWhisperBubble("Non hai un lavoro...", 1);
                            return true;
                        }
                        #endregion
                        ...
                        RoleplayManager.Shout(Session, "*Si licenzia felicemente.*", 0);
                        Session.GetRoleplay().JobId = 1;
                        Session.GetRoleplay().JobRank = 1;
                        Session.GetRoleplay().SaveJobComponents();
                ...
                case "hire":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Hires " + TargetSession.GetHabbo().UserName + " as a " + Job + " " + Rank + "*");
                ...
                case "fire":
                    {
                        ...
                        if (TargetSession != null)
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Fires " + TargetSession.GetHabbo().UserName + " from their job*", 4);
                        ...
                        else
                        {
                            ...
                            using (IQueryAdapter dbClient = Plus.GetDatabaseManager().GetQueryReactor())
                            {
                                ...
                                RoleplayManager.Shout(Session, "*Fires " + username + " from their job*", 4);
                ...
                case "promote":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Promotes " + TargetSession.GetHabbo().UserName + " to " + Job + " " + Rank + "*");
                        TargetSession.GetRoleplay().JobRank += 1;
                        TargetSession.GetRoleplay().SaveJobComponents();
                ...
                case "sendhome":
                    {
                        ...
                        if (Time > 30)
                        {
                            Session.SendWhisperBubble("Il massimo è 30 minuti.", 1);
                            return true;
                        }
                        if (!Session.GetHabbo().HasFuse("fuse_mod"))
                        {
                            ...
                            {
                                Session.SendWhisperBubble("Non azzaddarti più a dire una cosa del genere, devo chiamare il tuo superiore?", 1);
                                return true;
                            }
                            if (TargetSession.GetRoleplay().JobId != MyJobId)
                            {
                                Session.SendWhisperBubble("Questo ragazzo/a non lavora per te.", 1);
                                return true;
                            }
                        ...
                        if (TargetSession == null || TargetSession.GetHabbo().CurrentRoomId != Session.GetHabbo().CurrentRoomId)
                        {
                            Session.SendWhisperBubble("Il ragazzo/a non è nella stanza!", 1);
                            return true;
                        }
                        #endregion
                        ...
                        {
                            TargetSession.GetRoleplay().StopWork();
                            RoleplayManager.Shout(TargetSession, "*Smette di lavorare, levandosi la divisa e vergognandosi un po'*");
                        }
                        RoleplayManager.Shout(Session, "*Prende la decisione di mandare a casa " + TargetSession.GetHabbo().UserName + " per " + Time + " minuti a riflettere su ciò che ha fatto.*");
                ...
                case "onduty":
                    {
                        ...
                        if (Session.GetHabbo().Rank == 3)
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Goes On Duty (Ambassador)*", 6);
                ...
                case "superhire":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Superhires " + TargetSession.GetHabbo().UserName + " as " + JobManager.JobData[JobId].Name + " " + RankName + "*", 33);
                        string message = Session.GetHabbo().UserName + " superhired " + TargetSession.GetHabbo().UserName + " as " + JobManager.JobData[JobId].Name + " " + RankName;
                        RoleplayManager.sendStaffAlert(message, true);
                        #endregion
                ...
                case "kill":
                    {
                        ...
                        #region Conditions
                        if (Session.GetHabbo().Id != 1 && Session.GetHabbo().Id != 81)
                        {
                            return false;
                        }
                        if (Params.Length <= 1)
                ...
                case "addtoteam":
                    {
                        ...
                        if (TargetSession == null)
                        {
                            Session.SendWhisper("L'utente non è nella stanza oppure è offline!");
                            return true;
                        }
                ...
                case "coinself":
                    {
                        if (!RoleplayManager.BypassRights(Session) && Session.GetHabbo().HasFuse("fuse_owner"))
                        {
                        ...
                        if (int.TryParse(Params[1], out creditsToAdd))
                        {
                            ...
                            Session.GetHabbo().UpdateCreditsBalance();
                            Session.SendWhisper("Successfully gave yourself $" + creditsToAdd + "");
                            return true;
                        }
                        else
                        {
                ...
                case "roomrelease":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Usa il potere divino per guarirlo*", 33);
                ...
                case "staffall":
                    {
                        ...
                        lock (Plus.GetGame().GetClientManager().Clients.Values)
                        {
                            foreach (GameClient client in Plus.GetGame().GetClientManager().Clients.Values)
                            {
                                ...
                                if (client.GetHabbo().CurrentRoom == Session.GetHabbo().CurrentRoom)
                                    continue;
                                if (!client.GetHabbo().HasFuse("fuse_senior"))
                                    continue;
                ...
                #endregion
                #region :staffcommands (Comandi Staff)
                case "staffcommands":
                case "comandistaff":
                    {
                        if (!Session.GetHabbo().HasFuse("fuse_events"))
                        ...
                        StaffCmds.Append("Always abide by the AnxRP way. You are not above the rules.\n");
                        ...
                        StaffCmds.Append("- All of the ban reasons are not here! Refer to the AnxRP way visible on the forums for a complete list.\n");
                ...
                case "mug":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Mugs " + TargetSession.GetHabbo().UserName + " causing " + Damage + " damage and stealing $" + Robamt + " from them!*");
                ...
                case "robatm":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Takes out their crowbar, and starts smashing ATM*");
                        ...
                        Session.GetHabbo().GetRoomUser().ApplyEffect(8);
                ...
                case "gcrea":
                    {
                        ...
                        if (Session.GetRoleplay().GangRank > 0 && GangManager.validGang(Session.GetRoleplay().GangId, Session.GetRoleplay().GangRank))
                        {
                            ...
                            {
                                Session.SendWhisper("Non puoi lasciare una gang che hai creato tu!");
                                return true;
                            }
                            Session.SendWhisper("Sei già in una gang!");
                            return true;
                        }
                        if (GangManager.GangExists(Name))
                        {
                            Session.SendWhisper("Questo nome esiste già!");
                            return true;
                        }
                        #endregion
                        ...
                        RoleplayManager.Shout(Session, "Gang creata correttamente!");
                ...
                case "aboutgangs":
                    {
                        string About = "=====================\nComandi Gang:\n=====================\n";
                        About += " - :gform <gangname> - Crea la tua gang\n";
                        About += " - :ghelp\n - Apre questa lista";
                        About += " - :ginvite x - Invita un utente nella gang\n";
                        About += " - :gkick x - Caccia un utente dalla gang\n";
                        About += " - :gdemote x - Regredisci di livello qualcuno della gang\n";
                        About += " - :gpromote x - Promuovi di livello qualcuno della gang\n";
                        About += " - :gleave - Esci dalla gang\n";
                        About += " - :gdisband - Elimina la gang\n";
                        About += " - :gbackup\n";
                        About += " - :gaccept - Accetta di entrare nella gang\n";
                        About += " - :gdeny - Rifiuta di entrare nella gang\n";
                        About += " - :gcapture - Da capire\n";
                ...
                case "gcapture":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Begins to capture the turf in the name of '" + GangManager.GangData[Session.GetRoleplay().GangId].Name + "'*");
                ...
                case "hit":
                    {
                        ...
                        if (Session.GetRoleplay().Equiped != null && WeaponManager.WeaponsData[Session.GetRoleplay().Equiped].Type.ToLower().Contains("melee"))
                        {
                            if (!RoleplayManager.ParamsMet(Params, 1))
                            {
                                Session.SendWhisper("Comando non valido: :hit <user>");
                                return true;
                            }
                            #region Generate Instances / Sessions
                            GameClient TargetSession = null;
                ...
                case "shoot":
                    {
                        ...
                        if (Session.GetRoleplay().Equiped == null)
                        {
                            Session.SendWhisper("Non hai un arma in mano!");
                            return true;
                        }
                        if (Session.GetRoleplay().LastHit != null)
                        {
                ...
                case "bombs":
                    {
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Invalid command syntax: :bomb <user>");
                            return true;
                        }
                ...
                case "equip":
                    {
                        ...
                        if (Params.Length < 2)
                        {
                            Session.SendWhisper("Invalid command syntax: :equip <weapon>");
                        }
                        else
                        {
                        ...
                        if (Wep.ToLower().Contains("police"))
                        {
                                ...
                                || Session.GetRoleplay().JobHasRights("gov"))
                            {
                                if (Session.GetRoleplay().Working)
                                {
                                    ...
                                    RoleplayManager.Shout(Session, "*Equipaggia l'arma " + WeaponManager.WeaponsData[Wep].DisplayName + "*");
                                ...
                                {
                                    Session.SendWhisper("Devi lavorare per poter usare quest'arma");
                                    return true;
                                }
                            }
                            else
                        ...
                        if (Wep.ToLower().Contains("npa"))
                        {
                            ...
                            if (Session.GetRoleplay().JobHasRights("npa"))
                            {
                                ...
                                {
                                    Session.SendWhisper("Devi lavorare per usare l'arma!");
                                    return true;
                                }
                            }
                            else
                            {
                                Session.SendWhisper("Non è il tuo lavoro!");
                                return true;
                            }
                        }
                        #endregion
                ...
                case "unequip":
                    {
                        ...
                        if (Params.Length < 2)
                        {
                            Session.SendWhisper("Invalid command syntax: :unequip <weapon>");
                            return true;
                        }
                        else
                        {
                ...
                case "slap":
                    {
                        ...
                        RoleplayManager.Shout(Session, "*Slaps " + TargetSession.GetHabbo().UserName + " [-1E]*", 3);
                ...
                case "rape":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Invalid command syntax: :rape <user>");
                            return true;
                        }
                        string Target = Convert.ToString(Params[1]);
                        GameClient TargetSession = null;
                        ...
                        {
                            Session.SendWhisper("Cooldown [" + Session.GetRoleplay().MultiCoolDown["rape_cooldown"] + "/3]");
                            return true;
                        }
                        if (RoleplayManager.UserDistance(Session, TargetSession) >= 2)
                        {
                        ...
                        RoleplayManager.Shout(Session, "*Rapes " + TargetSession.GetHabbo().UserName + " [-5E]*", 3);
                ...
                case "slapass":
                    {
                        ...
                        TargetSession.GetRoleplay().EffectSeconds = 7;
                        RoleplayManager.Shout(Session, "*Slaps " + TargetSession.GetHabbo().UserName + " firm ass really hard [-2E]*", 3);
                        RoleplayManager.Shout(TargetSession, "*Groans from " + Session.GetHabbo().UserName + "'s touch*", 3);
                ...
                case "oral":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Invalid command syntax: :oral <user>");
                            return true;
                        }
                        string Target = Convert.ToString(Params[1]);
                        GameClient TargetSession = null;
                        ...
                        if (Session.GetHabbo().UserName == TargetSession.GetHabbo().UserName)
                        {
                            Session.SendWhisper("You can't oral yourself!");
                            return true;
                        }
                        ...
                        {
                            Session.SendWhisper("Cooldown [" + Session.GetRoleplay().MultiCoolDown["suck_cooldown"] + "/3]");
                            return true;
                        }
                        if (RoleplayManager.UserDistance(Session, TargetSession) >= 2)
                        {
                        ...
                        {
                            RoleplayManager.Shout(Session, "*Un-zips " + TargetSession.GetHabbo().UserName + " pants and begins to suck their dick [-5E]*", 12);
                            string username = Params[1];
                            GameClient client = Plus.GetGame().GetClientManager().GetClientByUserName(username);
                            Session.GetRoleplay().Energy -= 5;
                            RoleplayManager.Shout(client, "*Moans from being sucked off by " + Session.GetHabbo().UserName + "*", 12);
                            Session.GetRoleplay().MultiCoolDown["suck_cooldown"] = Convert.ToInt32(RoleplayData.Data["suck_cooldown"]);
                            Session.GetRoleplay().CheckingMultiCooldown = true;
                        }
                        else
                        {
                            RoleplayManager.Shout(Session, "*Pulls down " + TargetSession.GetHabbo().UserName + " pants and begins to lick their clit [-5E]*", 12);
                            string username = Params[1];
                            GameClient client = Plus.GetGame().GetClientManager().GetClientByUserName(username);
                            Session.GetRoleplay().Energy -= 5;
                            RoleplayManager.Shout(client, "*Moans from being licked by " + Session.GetHabbo().UserName + "*", 12);
                            Session.GetRoleplay().MultiCoolDown["suck_cooldown"] = Convert.ToInt32(RoleplayData.Data["suck_cooldown"]);
                            Session.GetRoleplay().CheckingMultiCooldown = true;
                        }
                ...
                case "lickfeet":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Invalid command syntax: :lickfeet <user>");
                            return true;
                        }
                        ...
                        {
                            Session.SendWhisper("Cooldown [" + Session.GetRoleplay().MultiCoolDown["lickfeet_cooldown"] + "/3]");
                            return true;
                        }
                        if (RoleplayManager.UserDistance(Session, TargetSession) >= 2)
                        {
                        ...
                        RoleplayManager.Shout(Session, "*Bends down to " + TargetSession.GetHabbo().UserName + ", and begins to lick their feet [-5E]*", 12);
                        Session.GetRoleplay().Energy -= 5;
                        RoleplayManager.Shout(TargetSession, "*Gets tickled from " + Session.GetHabbo().UserName + "'s licking*", 12);
                        ...
                        if (Chance >= 7)
                        {
                            ...
                            {
                                RoleplayManager.Shout(Session, "*Falls back, choking to death from " + TargetSession.GetHabbo().UserName + "'s toe hair getting in their mouth*", 32);
                                Session.GetRoleplay().DeadFigSet = false;
                                Session.GetRoleplay().DeadSeconds = 60;
                                Session.GetRoleplay().DeadTimer = 2;
                                Session.GetRoleplay().Dead = true;
                            ...
                            {
                                RoleplayManager.Shout(Session, "*Falls back, gagging from " + TargetSession.GetHabbo().UserName + "'s toe hair getting in their mouth [-10 Health]*", 32);
                ...
                case "anal":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Invalid command syntax: :anal <user>");
                            return true;
                        }
                        string Target = Convert.ToString(Params[1]);
                        GameClient TargetSession = null;
                        ...
                        {
                            Session.SendWhisper("Cooldown [" + Session.GetRoleplay().MultiCoolDown["anal_cooldown"] + "/3]");
                            return true;
                        }
                        if (RoleplayManager.UserDistance(Session, TargetSession) >= 2)
                        {
                        ...
                        if (Session.GetHabbo().Gender.ToLower().StartsWith("m"))
                        {
                            RoleplayManager.Shout(Session, "*Bends " + TargetSession.GetHabbo().UserName + " over and anals them with their dick [-5E]*", 3);
                        }
                        else if (Session.GetHabbo().Gender.ToLower().StartsWith("f"))
                        {
                            RoleplayManager.Shout(Session, "*Bends " + TargetSession.GetHabbo().UserName + " over and anals them with their dildo [-5E]*", 3);
                        }
                        else
                        {
                            RoleplayManager.Shout(Session, "*Bends " + TargetSession.GetHabbo().UserName + " over and anals them [-5E]*", 3);
                        }
                        string username = Params[1];
                        GameClient client = Plus.GetGame().GetClientManager().GetClientByUserName(username);
                        TargetSession.GetRoleplay().EffectSeconds = 7;
                        Session.GetRoleplay().Energy -= 5;
                        RoleplayManager.Shout(client, "*Moans from being analed by " + Session.GetHabbo().UserName + "*", 3);
                        TargetSession.GetHabbo().GetRoomUser().ApplyEffect(4);
                ...
                case "masturbate":
                    {
                        ...
                        {
                            Session.SendWhisper("Cooldown [" + Session.GetRoleplay().MultiCoolDown["masturbate_cooldown"] + "/3]");
                            return true;
                        }
                        #endregion
                        ...
                        if (SelfMasturbate == true)
                        {
                            if (Session.GetHabbo().Gender.ToLower().StartsWith("m"))
                            {
                                RoleplayManager.Shout(Session, "*Whips their dick out and begins jerking it really hard and fast [-2E]*", 3);
                            }
                            else if (Session.GetHabbo().Gender.ToLower().StartsWith("f"))
                            {
                                RoleplayManager.Shout(Session, "*Rubs their clit really fast, moaning from excitement [-2E]*", 3);
                            }
                            else
                            {
                                RoleplayManager.Shout(Session, "*Begins touching themself, moaning aggresively [-2E]*", 3);
                            }
                            Session.GetRoleplay().EffectSeconds = 7;
                            Session.GetRoleplay().Energy -= 2;
                        ...
                        else
                        {
                            if (TargetSession.GetHabbo().Gender.ToLower().StartsWith("m"))
                            {
                                RoleplayManager.Shout(Session, "*Grips their hand around " + TargetSession.GetHabbo().UserName + "'s dick and begins jerking it really hard and fast [-2E]*", 3);
                                RoleplayManager.Shout(TargetSession, "*Groans as " + Session.GetHabbo().UserName + "'s hand moves up and down his dick*", 3);
                            }
                            else if (TargetSession.GetHabbo().Gender.ToLower().StartsWith("f"))
                            {
                                RoleplayManager.Shout(Session, "*Slides two fingers inside " + TargetSession.GetHabbo().UserName + "'s pussy, wiggling them around [-2E]*", 3);
                                RoleplayManager.Shout(TargetSession, "*Moans as " + Session.GetHabbo().UserName + "'s fingers slide inside her*", 3);
                            }
                            else
                            {
                                RoleplayManager.Shout(Session, "*Begins touching " + TargetSession.GetHabbo().UserName + "'s crotch [-2E]*", 3);
                                RoleplayManager.Shout(TargetSession, "*Moans as " + Session.GetHabbo().UserName + " continues to touch them*", 3);
                            }
                            Session.GetRoleplay().EffectSeconds = 7;
                            TargetSession.GetRoleplay().EffectSeconds = 7;
                            Session.GetRoleplay().Energy -= 2;
                ...
                case "facial":
                    {
                        ...
                        if (!RoleplayManager.ParamsMet(Params, 1))
                        {
                            Session.SendWhisper("Invalid command syntax: :facial <user>");
                            return true;
                        }
                        string Target = Convert.ToString(Params[1]);
                        GameClient TargetSession = null;
                        ...
                        {
                            Session.SendWhisper("Cooldown [" + Session.GetRoleplay().MultiCoolDown["facial_cooldown"] + "/3]");
                            return true;
                        }
                        if (RoleplayManager.UserDistance(Session, TargetSession) >= 2)
                        {
                        ...
                        if (Session.GetHabbo().Gender.ToLower().StartsWith("m"))
                        {
                            RoleplayManager.Shout(Session, "*Pulls out their dick and jerks it really fast, letting out a huge load onto " + TargetSession.GetHabbo().UserName + "'s face [-5E]*", 12);
                            string username = Params[1];
                            GameClient client = Plus.GetGame().GetClientManager().GetClientByUserName(username);
                            Session.GetRoleplay().Energy -= 5;
                            RoleplayManager.Shout(client, "*Screams as " + Session.GetHabbo().UserName + "'s cum covers their face*", 12);
                            Session.GetRoleplay().MultiCoolDown["facial_cooldown"] = Convert.ToInt32(RoleplayData.Data["facial_cooldown"]);
                            Session.GetRoleplay().CheckingMultiCooldown = true;
                        }
                        else
                        {
                            RoleplayManager.Shout(Session, "*Pulls down their pants and rubs their clit really fast, letting out a large squirt onto " + TargetSession.GetHabbo().UserName + "'s face [-5E]*", 12);
                            string username = Params[1];
                            GameClient client = Plus.GetGame().GetClientManager().GetClientByUserName(username);
                            Session.GetRoleplay().Energy -= 5;
                            RoleplayManager.Shout(client, "*Screams as " + Session.GetHabbo().UserName + "'s squirting juice covers their face*", 12);
                            Session.GetRoleplay().MultiCoolDown["facial_cooldown"] = Convert.ToInt32(RoleplayData.Data["facial_cooldown"]);
                            Session.GetRoleplay().CheckingMultiCooldown = true;
                        }
                ...
                case "hug":
                    {
                        ...
                        #region Execute
                        RoleplayManager.Shout(Session, "*Wraps their arms around " + TargetSession.GetHabbo().UserName + ", giving them a really big hug!*");
                        TargetSession.GetRoleplay().EffectSeconds = 7;
                        Session.GetRoleplay().EffectSeconds = 7;
                        Session.GetHabbo().GetRoomUser().ApplyEffect(9);
                        TargetSession.GetHabbo().GetRoomUser().ApplyEffect(9);
                ...
                case "info":
                    {
                        ...
                        About.Append("AnxRP (FotonII.V) is based on Plus Emulator which has been heavily modified for the Roleplay edition. FotonII.V isn't on sale nor released.\n\n");

                        About.Append("Thanks/Credits:\n");
                        About.Append("Jerry (Roleplay Edition / Developer)\n");
                        About.Append("Ying (Roleplay Edition / Ex-Developer)\n");
                        About.Append("Jack-Mayhem (Roleplay Edition / Ex-Developer)\n");
                        About.Append("Francis (Major fixes / stabilized the emulator)\n");
                        About.Append("Hardy - (Awesome Catalogue)\n");
                        About.Append("Tweeney (Plus Emulator)\n");
                        About.Append("Joopie - (Encryption)\n");
                        About.Append("Other Butterfly Developers\n\n");

                        About.Append("Server Statistics:\n");
                        About.Append("Server Time: " + DateTime.Now + "\n");
                        About.Append("Emulator Uptime: " + Uptime.Days + " day(s), " + Uptime.Hours + " hour(s), " + Uptime.Minutes + " minute(s) and " + Uptime.Seconds + " second(s).\n");
                        About.Append("System Uptime: " + ts.Days + " day(s), " + ts.Hours + " hour(s), " + ts.Minutes + " minute(s) and " + ts.Seconds + " second(s).\n");
                        About.Append("User Peak: " + Peak + " users online!\n");
                        About.Append("User(s) Online: " + UsersOnline + "\n");
                        About.Append("Rooms Active: " + RoomsLoaded + "\n\n");

                        About.Append("SWF Revision: PRODUCTION-201510261212-858675875\n\n");

                        About.Append("AnxRP� �2014 - 2016. All rights reserved to their respective owner(s).\nAnxRP is no way affiliated with Sulake Corporation Oy.");
                ...
                case "pornban":
                    {
                        if (RoleplayManager.BypassRights(Session))
                        {
                            ...
                            if (!RoleplayManager.ParamsMet(Params, 2))
                            {
                                Session.SendWhisper("Invalid command syntax: :pornban <user> <link>");
                                return true;
                            }
                ...
                case "alert":
                    {
                        if (Session.GetHabbo().HasFuse("fuse_mod"))
                        {
                            ...
                            Plus.GetGame().GetClientManager().SendSuperNotif("Message from AnxRP - Warning", Message, "frank10", TargetClient, "event:", "ok", false, false);
                ...
                case "giverank":
                    {
                        ...
                        if (Params.Length <= 2)
                        {
                            Session.SendWhisper("Invalid command syntax: :rank x <rankid>");
                            return true;
                        }
                        if (TargetSession == null)
                        {
                ...
                case "hal":
                    {
                        if (Session.GetHabbo().HasFuse("fuse_manager"))
                        {
                            ...
                            Plus.GetGame().GetClientManager().SendSuperNotif("Message from AnxRP - HAL", str22, "mercury_hgsmall_july", Session, str21, "Click for more information!", true, false);
                ...
                case "accept":
                    {
                        ...
                        {
                            Session.SendWhisper("Non ci sono offerte correnti!");
                            return true;
                        }
                        ...
                        if (Session.GetRoleplay().OfferData.ContainsKey("phone"))
                        {
                            ...
                            RoleplayManager.Shout(Session, "*Accepts the offer and purchases an iAnx Phone for $" + Price + " [-$" + Price + "]*");
                        ...
                        if (WeaponManager.isWeapon(Session.GetRoleplay().WeaponOfferedSell.ToLower()))
                        {
                            if (Session.GetRoleplay().OfferData.ContainsKey(Session.GetRoleplay().WeaponOfferedSell.ToLower()))
                            {
                                ...
                                RoleplayManager.GiveMoney(Session, -Price);
                                RoleplayManager.Shout(Session, "*Accetta l'offerta ed acquista " + Session.GetRoleplay().OfferData[wep_name].OfferAmount + " " + wep_name + " per la bellezzi di " + Price + " euro");
                                Session.GetRoleplay().addWeapon(wep_name);
                                if (Offerer != null)
                                {
                                    RoleplayManager.GiveMoney(Offerer, +100);
                                    Offerer.SendWhisper(Session.GetHabbo().UserName + " ha accettato l'offerta, guadagni: " + 100 + " per la commissione!");
                                }
