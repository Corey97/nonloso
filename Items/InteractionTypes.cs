...
namespace Plus.HabboHotel.Items
{
    ...
    internal static class InteractionTypes
    {
        ...
        internal static bool AreFamiliar(GlobalInteractions type, Interaction subType) // Xdr Idea
        {
            switch (type)
            {
        ...
        internal static Interaction GetTypeFromString(string pType)
        {
            switch (pType)
            {
                ...
                case "firegate":
                    return Interaction.FireGate;

                case "glassfoor":
                    return Interaction.GlassFoor;
                ...
                case "wire":
                    return Interaction.Wire;

                case "wireCenter":
                    return Interaction.WireCenter;

                case "wireCorner":
                    return Interaction.WireCorner;

                case "wireSplitter":
                    return Interaction.WireSplitter;

                case "wireStandard":
                    return Interaction.WireStandard;
                ...
                case "wf_cnd_has_handitem":
                    return Interaction.ConditionBotHasHanditem;
                ...
                case "rp":
                    return Interaction.rp;

                case "trash_cans":
                    return Interaction.trash_cans;

                case "slotmachine":
                    return Interaction.slotmachine;

                case "minefield":
                    return Interaction.minefield;

                case "walk_internal_link":
                    return Interaction.WalkInternalLink;

                case "crafting":
                    return Interaction.Crafting;
