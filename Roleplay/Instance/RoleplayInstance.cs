...
namespace Plus.HabboHotel.Roleplay.Instance
{
    public class RoleplayInstance : IDisposable
    {
        ...
        public RoleplayInstance(uint UserId, int CurHealth, int MaxHealth, int Energy, int Hunger, int Hygiene,
            ...
            int spaceLevel, int spaceXP, int farmingLevel, int farmingXP, int Carrots,
        ...
        public void StopWork(bool SendSpeech = false)
        {
            ...
            if (SendSpeech)
            {
                RoleplayManager.Shout(Session, "*Finalmente si leva la divisa da lavoro, pronto a godersi il resto della giornata.*", 1);
            }
        }
        ...
        public void CallPolice()
        {
            ...
            Misc.RoleplayManager.Shout(mClient, "*Chiama la polizia*");
        }
        ...
        public void UnEquip()
        {
            ...
            User.CarryItem(0);
            User.ApplyEffect(0);
            RoleplayManager.Shout(Session, "*Posa l'arma*");
