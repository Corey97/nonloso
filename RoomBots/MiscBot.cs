...
namespace Plus.HabboHotel.RoomBots
{
    class MiscBot : BotAI
    {
        ...
        {
            string[] special = { "ordina pancakes", "ordina steak", "ordina chips", "ordina eggs", "ordina spaghetti", "ordina milkshakes" };
            ...
            if (base.GetRoom().RoomData.Description.Contains("STORE"))
            {
                ...
                if (base.GetRoom().RoomData.Description.Contains("EATERY"))
                {
                    ...
                    if (!event_serving)
                    {
                        if (SpecialMsg)
                        {
                            ...
                            if (specialMsg.Contains("ordina"))
                            {
                                ...
                                {
                                    User.GetClient().SendWhisper("Siediti pure prima di ordinare!");
                                    return;
                                }

                                if (User.GetClient().GetRoleplay().Hunger <= 0)
                                {
                                    User.GetClient().SendWhisper("Sei già pieno, non hai bisogno di altro cibo!");
                                    return;
                                }

                                GetRoomUser().Chat(null, "Arriviamo subito caro!", true, 0);
                    ...
                    else
                    {
                        if (SpecialMsg)
                        {
                            User.GetClient().SendWhisper("Stiamo preparando un altro ordine, attendi qualche istante!");
        ...
        internal override void OnTimerTick()
        {
            if (base.GetBotData() != null)
            {
                ...
                if (base.GetBotData().InteractingWith != null && base.GetBotData().Name.Contains("BOT"))
                {
                    ...
                    else
                    {
                        ...
                        if (Robbed && !Done)
                        {
                            ...
                            {
                                base.GetRoomUser().Chat(null, "Per questa volta ti salvo!", true, 1);
                                Done = true;
                                return;
                            }

                            base.GetRoomUser().Chat(null, "*Ruba " + Amnt + " euro da " + base.GetBotData().InteractingWith.GetClient().GetHabbo().UserName + " e corre via come un matto.*", true, 1);
                ...
                else
                {
                    if (base.GetBotData() != null)
                    {
                        if (base.GetBotData().Name.Contains("BOT"))
                        {
                            if (base.GetBotData().InteractingWith == null && base.GetBotData().Name.Contains("BOT") || base.GetBotData().InteractingWith.GetClient().GetHabbo().CurrentRoomId != base.GetBotData().RoomId)
                            {
                ...
                if (base.GetBotData().InteractingWith != null && base.GetBotData().Name.Contains("BOT 2"))
                {
                    HabboHotel.PathFinding.Vector2D Pos1 = new HabboHotel.PathFinding.Vector2D(base.GetRoomUser().X, base.GetRoomUser().Y);
                ...
                else
                {
                    if (base.GetBotData() != null)
                    {
                        if (base.GetBotData().Name.Contains("BOT 2"))
                        {
                            if (base.GetBotData().InteractingWith == null && base.GetBotData().Name.Contains("BOT 2") || base.GetBotData().InteractingWith.GetClient().GetHabbo().CurrentRoomId != base.GetBotData().RoomId)
                            {
                                RoleplayManager.KickBotFromRoom(base.GetRoomUser().BotData.Name, base.GetBotData().RoomId);
                            }
                        }
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (!event_serving_delivered)
                                    {
                                        ...
                                        GetRoomUser().Chat(null, "Ecco a te, appena sfornato!", true, 1);
